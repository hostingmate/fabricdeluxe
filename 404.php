			...
			<section id="content" class="container-fluid no-gutters no-padding-sides">
					...
					<div class="container my-5">
						<div class="row my-5">
							<div class="col-12 text-center my-5">
								<div class="mb-5">
									<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100px" height="100px" viewBox="0 0 274.227 274.228" style="enable-background:new 0 0 274.227 274.228;" xml:space="preserve">
									<g>
										<g>
								...
								<h3 class="m-0">OOPS, SORRY WE CAN'T FIND THAT PAGE</h3>
								<h6>Either something went wrong or the page doesn't exist anymore.</h6>
								<a class="btn button mt-5" href="https://www.fabricdeluxe.com.au/" title="Fabric Deluxe">HOME PAGE</a>
							</div>
						</div>
					</div>
				</div>
